...
typedef struct {
	...
	_RW PUD;                         /* Offset 0x08 */
	_RW DRV;                         /* Offset 0x0C */
	_RW CONPDN;                      /* Offset 0x10 */
	_RW PUDPDN;                      /* Offset 0x14 */
	_NU RESERVE0[2];                 /* Reserve 0x08 */
} _GPIO_Struct;                      /* Sizes 32 */

typedef struct {
	_GPIO_Struct A0;                 /* Offset 0x0000 */
	_GPIO_Struct A1;                 /* Offset 0x0020 */
	_GPIO_Struct B;                  /* Offset 0x0040 */
	_GPIO_Struct C0;                 /* Offset 0x0060 */
	_GPIO_Struct C1;                 /* Offset 0x0080 */
	_GPIO_Struct D0;                 /* Offset 0x00A0 */
	_GPIO_Struct D1;                 /* Offset 0x00C0 */
	_GPIO_Struct E0;                 /* Offset 0x00E0 */
	_GPIO_Struct E1;                 /* Offset 0x0100 */
	_GPIO_Struct F0;                 /* Offset 0x0120 */
	_GPIO_Struct F1;                 /* Offset 0x0140 */
	_GPIO_Struct F2;                 /* Offset 0x0160 */
	_GPIO_Struct F3;                 /* Offset 0x0180 */
	_GPIO_Struct G0;                 /* Offset 0x01A0 */
	_GPIO_Struct G1;                 /* Offset 0x01C0 */
	_GPIO_Struct G2;                 /* Offset 0x01E0 */
	_GPIO_Struct G3;                 /* Offset 0x0200 */
	_GPIO_Struct I;                  /* Offset 0x0220 */
	_GPIO_Struct J0;                 /* Offset 0x0240 */
	_GPIO_Struct J1;                 /* Offset 0x0260 */
	_GPIO_Struct J2;                 /* Offset 0x0280 */
	_GPIO_Struct J3;                 /* Offset 0x02A0 */
	_GPIO_Struct J4;                 /* Offset 0x02C0 */
	_GPIO_Struct MP0_1;              /* Offset 0x02E0 */
	_GPIO_Struct MP0_2;              /* Offset 0x0300 */
	_GPIO_Struct MP0_3;              /* Offset 0x0320 */
	_GPIO_Struct MP0_4;              /* Offset 0x0340 */
	_GPIO_Struct MP0_5;              /* Offset 0x0360 */
	_GPIO_Struct MP0_6;              /* Offset 0x0380 */
	_GPIO_Struct MP0_7;              /* Offset 0x03A0 */
	_GPIO_Struct MP1_0;              /* Offset 0x03C0 */
	_GPIO_Struct MP1_1;              /* Offset 0x03E0 */
	_GPIO_Struct MP1_2;              /* Offset 0x0400 */
	_GPIO_Struct MP1_3;              /* Offset 0x0420 */
	_GPIO_Struct MP1_4;              /* Offset 0x0440 */
	_GPIO_Struct MP1_5;              /* Offset 0x0460 */
	_GPIO_Struct MP1_6;              /* Offset 0x0480 */
	_GPIO_Struct MP1_7;              /* Offset 0x04A0 */
	_GPIO_Struct MP1_8;              /* Offset 0x04C0 */
	_GPIO_Struct MP2_0;              /* Offset 0x04E0 */
	_GPIO_Struct MP2_1;              /* Offset 0x0500 */
	_GPIO_Struct MP2_2;              /* Offset 0x0520 */
	_GPIO_Struct MP2_3;              /* Offset 0x0540 */
	_GPIO_Struct MP2_4;              /* Offset 0x0560 */
	_GPIO_Struct MP2_5;              /* Offset 0x0580 */
	_GPIO_Struct MP2_6;              /* Offset 0x05A0 */
	_GPIO_Struct MP2_7;              /* Offset 0x05C0 */
	_GPIO_Struct MP2_8;              /* Offset 0x05E0 */
	_GPIO_Struct ETC0;               /* offste 0x0600 */
	_GPIO_Struct ETC1;               /* offste 0x0620 */
	_GPIO_Struct ETC2;               /* offste 0x0640 */
	_NU RESERVE1[40];                /* Reserve 0x00A0 */
    ...
    _GPIO_Struct H0;                 /* Offset 0x0C00 */
    _GPIO_Struct H1;                 /* Offset 0x0C20 */
    _GPIO_Struct H2;                 /* Offset 0x0C40 */
    _GPIO_Struct H3;                 /* Offset 0x0C60 */
